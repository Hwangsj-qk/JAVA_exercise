...
public class Class4 {
    public static void main(String[] args) {
        ...
        // 메소드 추출(Extract Method) 기능으로 객체의 필드에 접근하는 반복되는 코드 블록을 메서드로 만든다.
        // 메서드를 통해 전달받은 객체 정보를 읽어서 출력할 수 있다.
    ...
    private static void printInformation(Student students) {
        System.out.println("[ 학생 이름 : " + students.name + ", 점수 : " + students.score +
                " 나이 : " + students.age + " ]");
    }
