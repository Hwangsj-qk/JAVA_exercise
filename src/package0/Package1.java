...
// 패키지 안에 있는 여러가지를 쓸 경우 *를 사용한다 (클래스명 생략 가능)

import package0.first.Book;
...
public class Package1 {
    public static void main(String[] args) {
        ...
        // 패키지에 접근하려면, 패키지 전체 경로를 포함해 클래스를 적어줘야 하다.
        package0.first.Person person = new package0.first.Person();

        // 다른 패키지 위치의 클래스를 import를 사용하려면 패키지명 생략하고 클래스 이름만 사용 가능
